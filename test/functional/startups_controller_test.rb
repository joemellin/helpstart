...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { startup_name: @startup.startup_name, stup_angel: @startup.stup_angel, stup_desc: @startup.stup_desc }
    end
  ...
  test "should update startup" do
    put :update, id: @startup, startup: { startup_name: @startup.startup_name, stup_angel: @startup.stup_angel, stup_desc: @startup.stup_desc }
    assert_redirected_to startup_path(assigns(:startup))
  end
